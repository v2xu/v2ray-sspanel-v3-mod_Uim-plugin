...
downloadV2Ray(){
    ...
    DOWNLOAD_LINK="https://github.com/v2rayv3/pay-v2ray-sspanel-v3-mod_Uim-plugin/releases/download/v4.21.2/v2ray-linux-64.zip"
...
getVersion(){
    if [[ -n "$VERSION" ]]; then
        ...
        TAG_URL="https://api.github.com/repos/v2xy/v2ray-sspanel-v3-mod_Uim-plugin/releases/latest"
